...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    public static final String ACTION_PLAY = "com.example.rshushilkumar.mplayer.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.example.rshushilkumar.mplayer.ACTION_PAUSE";
    public static final String ACTION_PREVIOUS = "com.example.rshushilkumar.mplayer.ACTION_PREVIOUS";
    public static final String ACTION_NEXT = "com.example.rshushilkumar.mplayer.ACTION_NEXT";
    public static final String ACTION_STOP = "com.example.rshushilkumar.mplayer.ACTION_STOP";
...
//                .setPriority(NotificationCompat.PRIORITY_DEFAULT);
    ...
    private void updateMetaData() {
        Bitmap albumArt = BitmapFactory.decodeResource(getResources(),
                R.drawable.ic_play_button); //replace with medias albumArt
